...
{
	public static final String url_nhsAccountCreation = "https://blue.testlab.nhs.uk/cicauth/realms/NHS/account/dashboard";
	public static final String url_nhsAccountRealmAdmin = "https://blue.testlab.nhs.uk/cicauth/admin/NHS/console";
	public static final String environmentVariable = "local";
	//public static final String environmentVariable = "remote";

	public static final String url__mailCatcher_local = "https://blue.testlab.nhs.uk/";
	...
	public static final String xpath_loginPage_registerLink = ".//*[@id='content']/div/div/div[1]/div/div/div/a/label";
	...
	//Security code --> .//*[@id='content']/div/div/div[2]/div/form/fieldset/h3
	//invalid movbile no message --> .//*[@id='content']/div/div/div[2]/div/div/div
	//Invalid mobile number. Please enter a valid UK mobile number.
	
	public static final String xpath_otpPhoneNoPage_legend = ".//*[@id='content']/div/div/div[1]/div/form/div[1]/fieldset/h1/legend";
	//-->.//*[@id='content']/div/div/div[2]/div/form/fieldset/h2
	public static final String xpath_otpPhoneNoPage_content1 = ".//*[@id='content']/div/div/div[1]/div/form/div[1]/fieldset/p[1]";
	public static final String xpath_otpPhoneNoPage_content2 = ".//*[@id='content']/div/div/div[1]/div/form/div[1]/fieldset/p[2]";
	//-->.//*[@id='content']/div/div/div[2]/div/form/fieldset/p
	public static final String xpath_otpPhoneNoPage_phoneNoInputBox = ".//*[@id='phone-number']";
	//-->.//*[@id='mobile_number']
	public static final String xpath_otpPhoneNoPage_continueButton = ".//*[@id='continue']";
	//-->.//*[@id='content']/div/div/div[2]/div/form/fieldset/div[2]/div/input
	
	//Security code --> .//*[@id='content']/div/div/div[1]/div/form/fieldset/h2
	//--> .//*[@id='content']/div/div/div[1]/div/form/fieldset/p[1]
	//Enter security code  We have sent a security code to your phone 074XXXXX456 
	//otp entered input box --> .//*[@id='otp_entered']
	//Continue button --> .//*[@id='content']/div/div/div[1]/div/form/fieldset/div[2]/div/input
	//bad otp message -> .//*[@id='content']/div/div/div[1]/div/div/div
	//resend otp .//*[@id='content']/div/div/div[1]/div/form/fieldset/p[2]/a
